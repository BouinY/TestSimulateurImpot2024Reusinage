...
public class Simulateur {
    ...
    private int rNet = 0; //Revenue NET
    private int nbEnf = 0;
    ...
    //Variable rajouté par Yohan BOUIN LE 20/02/2026
    ...
    //Setter rajouté par Yohan BOUIN LE 13/02/2026
    public void setRevenusNet(int revenuNet) {
        rNet = revenuNet;
    }

    //Setter rajouté par Yohan BOUIN LE 20/02/2026
	...
	//Fonction rajouté par Yohan BOUIN LE 20/02/2026
	public void calculImpotSurRevenuNet() {
		mImp = calculImpot(rNet, sitFam, nbEnf, nbEnfH, parIso);
	}

	//Getter rajouté par Yohan BOUIN LE 20/02/2026
