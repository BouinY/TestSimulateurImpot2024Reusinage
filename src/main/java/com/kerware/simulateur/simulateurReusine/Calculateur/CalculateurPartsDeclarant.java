...
public class CalculateurPartsDeclarant {
  public static double calcul(SituationFamiliale situationFamiliale) {
    ...
    switch (situationFamiliale) {
      ...
      case VEUF:
        /*
       * if ( nbEnfantTotal == 0 ) { nbPartsDeclarant = 1; } else { nbPartsDeclarant =
       * 2; }
       */
        nbPartsDeclarant = 1; 
        // Dans le code originel le if else est suivi de cette ligne le rendant inutile,
        // je laisse le code car je ne sais pas si il fallait corrigée sachant que cela
        // pour casser les test.
        break;
      default:
        nbPartsDeclarant = 1;
        break;
